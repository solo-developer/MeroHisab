        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputGroup}>
            ...
            <RNPickerSelect
              ...
              style={pickerStyles}
              placeholder={{}}
              Icon={() => <Ionicons name="wallet-outline" size={20} color="#2E7D32" style={{ marginTop: 12, marginRight: 10 }} />}
            />
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <RNPickerSelect
              ...
              style={pickerStyles}
              placeholder={{}}
              Icon={() => <Ionicons name="grid-outline" size={20} color="#2E7D32" style={{ marginTop: 12, marginRight: 10 }} />}
            />
          </View>
