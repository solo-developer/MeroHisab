    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <View style={styles.receiptBadge}>
          <Ionicons name="arrow-redo-outline" size={12} color="#2E7D32" />
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom', 'left', 'right']}>
      <View style={styles.headerBar}>
        ...
        <Text style={styles.headerTitle}>Receipts View</Text>
        <TouchableOpacity onPress={() => ExportHelper.exportReport('Receipts_Report', receipts)} style={styles.actionButton}>
      ...
      <View style={styles.heroSection}>
        <View style={styles.searchBar}>
          ...
          <TextInput
            placeholder="Search party or receipt note..."
      ...
      <View style={styles.summaryBox}>
        <View style={styles.heroIconBox}>
          <Ionicons name="arrow-redo-outline" size={20} color="#2E7D32" />
        </View>
        <View style={{ flex: 1, marginLeft: 16 }}>
          <Text style={styles.summaryLabel}>Total Received</Text>
          <Text style={styles.summaryValue}>₹{totalReceipts.toFixed(0)}</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  summaryLabel: { fontSize: 11, color: '#1B5E20', fontWeight: '700', textTransform: 'uppercase' },
  summaryValue: { fontSize: 26, fontWeight: '900', color: '#2E7D32' },
  ...
  receiptBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#E8F5E9', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  receiptBadgeText: { fontSize: 9, fontWeight: '800', color: '#2E7D32' },
  ...
  amount: { fontSize: 17, fontWeight: '900', color: '#2E7D32' },
